...
\nopagebreak &\multicolumn{2}{p{5.75in}}{\small{#5}}\\
...
\lang{svn}{SVN}
\lang{swing}{Swing}
\lang{springboot}{Spring Boot}
\lang{maven}{Maven}
\lang{elasticsearch}{Elastic Search}
\lang{redis}{Redis}
\lang{rabbitmq}{RabbitMQ}
\lang{postgresql}{PostgreSQL}
\lang{oracle}{Oracle}
\lang{git}{Git}
\lang{kubernetes}{Kubernetes}
